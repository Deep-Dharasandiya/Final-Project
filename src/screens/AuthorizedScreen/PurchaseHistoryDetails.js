        ...
        <View style={CommonStyles.containerBlurPurple}>
            ...
            <ScrollView>
                ...
                <View style={{ marginLeft: 15 * unit, marginTop: 15 * unit }}>
                    ...
                    <Text style={{ ...CommonStyles.font2Black, fontWeight: '500' }}>Sold By:</Text>
                    <View style={styles.profileView}>
                        <View style={{ marginLeft: 10 * unit }}>
                            <Text style={CommonStyles.font3Purple}>{bookDetails.sellerID.firstName + " " + bookDetails.sellerID.lastName}</Text>
                            <Text style={{ ...CommonStyles.font1Black, fontWeight: '300' }}>{bookDetails.sellerID.college}</Text>
                            <Text style={{ ...CommonStyles.font1Black, fontWeight: '300' }}>{bookDetails.sellerID.city}</Text>
                        </View>
                        <Image
                            source={{ uri: bookDetails.sellerID.profileURL }}
                    ...
                    <View style={{ ...CommonStyles.textView, marginTop: 0 }}>
                        <Text style={{ ...CommonStyles.font1Black, fontWeight: '300' }}>{bookDetails.sellerID.email}</Text>
                    </View>
                </View>
            </ScrollView>
        </View>
