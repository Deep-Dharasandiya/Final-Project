...
import {  GetSoldHistory } from '../../networkServices/AuthenticationServices'
            ...
            <View style={styles.appBar}>
                <View style={styles.appBarBody}>
                    <View style={{ flexDirection: 'row', ...CommonStyles.centerAlignMent }}>
                        ...
                        <Text style={{ ...CommonStyles.font4White, marginLeft: 15 * unit }}>Sold Books</Text>
                    </View>
                </View>
                            ...
                            <FlatList
                                ...
                                renderItem={({ item, index }) => {
                                    ...
                                    <TouchableOpacity style={CommonStyles.itemView}
                                         onPress={() => props.navigation.navigate('SoldHistoryDetails', { item: item })}
                                    >
                                        <View style={{ flex: 1 }}>
